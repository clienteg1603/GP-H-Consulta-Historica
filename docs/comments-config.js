...
// A chave abaixo é a chave pública/anon do Supabase e pode ficar no frontend.
window.GPH_COMMENTS = {
  submitUrl: "https://vzhkuewuedfwjvwdwpob.supabase.co/functions/v1/gph-comments",
  listUrl: "https://vzhkuewuedfwjvwdwpob.supabase.co/functions/v1/gph-comments-public",
  publicHeaders: {
...
document.addEventListener("DOMContentLoaded", () => {
  const screenshot = document.querySelector(".screenshot-wrap img");
  if (screenshot) screenshot.style.filter = "brightness(1.05) contrast(1.02)";
});
