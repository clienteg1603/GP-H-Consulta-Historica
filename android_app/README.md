...
Versão de desenvolvimento: **0.1.15 alpha 18**.

Implementado:

- interface própria para Android com Layout v1 e tema escuro padronizado;
- banco SQLite local;
...
- Estatísticas de frequência e atraso dos 25 bichos;
- Números fortes por bicho;
- atrasos de Dezena e Centena;
- fichas históricas de bichos e números;
- identificação visual dos 25 bichos com glifos nativos, sem dependência de imagens externas;
...
Quando o número de build disponível for maior que o instalado, o GP-H mostra uma janela com a nova versão e o botão **Baixar**.
...
Durante a fase alpha é usada uma chave de assinatura exclusiva de testes. Ela é preservada pelo canal `android-release` para que as novas alphas possam ser instaladas por cima da versão anterior sem desinstalar o aplicativo nem apagar a base local.
